...
public:
    ...
    */
    ...
    void ProcessMempoolValidationResponse(CConnman * connman, CNode * pfrom, const CTransactionRef& transaction,
                                          const TransactionSubmissionResponse& response) override;
