...
BOOST_AUTO_TEST_CASE(merkleblock_construct_from_txids_found)
{
    ...
    // Last txn in block.
    TxId txhash1 = TxId(uint256S("0x74d681e0e03bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20"));

    // Second txn in block.
    TxId txhash2 = TxId(uint256S("0xf9fc751cb7dc372406a9f8d738d5e6f8f63bab71986a39cf36ee70ee17036d07"));
...
BOOST_AUTO_TEST_CASE(merkleblock_construct_from_txids_not_found)
{
    ...
    std::set<TxId> txids2;
    txids2.insert(TxId(uint256S("0xc0ffee00003bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20")));
